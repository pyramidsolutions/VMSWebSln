...
{
    public class ManageVehicleType
    {
        SqlConnection conn;
        ...
        public DataTable getVehicleTypeList(string connectionString)
        {
            ...
            {
                conn = DBUtility.createConnection(connectionString);
                SqlCommand cmdIns = DBUtility.PrepareReadCommand("sp_GetVehicleTypeList", conn);
